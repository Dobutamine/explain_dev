...
class ANS {
  ...
  modelCycle() {
    ...
    this._model.calcAcidbaseFromTCO2(this._model.components["AA"], this._model);
    this._model.calcOxygenationFromTO2(this._model.components["AA"], this._model);

    this._model.calcAcidbaseFromTCO2(this._model.components["AD"], this._model);
    this._model.calcOxygenationFromTO2(this._model.components["AD"], this._model);

    this._model.calcAcidbaseFromTCO2(this._model.components["RA"], this._model);
    this._model.calcOxygenationFromTO2(this._model.components["RA"], this._model);

    this._model.calcAcidbaseFromTCO2(this._model.components["VCII"], this._model);
    this._model.calcOxygenationFromTO2(this._model.components["VCII"], this._model);

    this._model.calcAcidbaseFromTCO2(this._model.components["VCS"], this._model);
    this._model.calcOxygenationFromTO2(this._model.components["VCS"], this._model);
