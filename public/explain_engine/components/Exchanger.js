...
class Exchanger {
  ...
  modelCycle() {
    ...
    // diff = mmol / mmHg * sec
    // flux is in mmol !!!
    this._model.calcAcidbaseFromTCO2(this._model.components[this.comp_blood], this._model);
    this._model.calcOxygenationFromTO2(this._model.components[this.comp_blood], this._model);
